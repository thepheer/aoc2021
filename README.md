# [AoC 2021](https://adventofcode.com/2021) in multiple languages
```
┌────────────────────────────────────────────────────────────────────────────────────┐
...
```
$ kotlin -version
Kotlin version 1.6.10-release-923 (JRE 17.0.1+12-Ubuntu-120.04)
```
```
$ nim --version
...
```
$ odin version
odin version dev-2021-12-nightly:9f0a30e3
```
```
$ rustc --version
